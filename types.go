...
type HttpHeader struct {
	...
	// OpenAPI extension.
	ClientDefault *Literal          `json:"clientDefault,omitempty"`
	V2Examples    *V2SchemaExamples `json:"v2Examples,omitempty"`
}
...
type GenerationMetadata struct {
	...
	OriginGitCommit *string `json:"originGitCommit,omitempty"`
}
...
type DateTimeRfc2822Type struct {
}

func (d *DateTimeRfc2822Type) String() string {
	if value, err := core.StringifyJSON(d); err == nil {
		return value
	}
	return fmt.Sprintf("%#v", d)
...
type EnumTypeDeclaration struct {
	...
	ForwardCompatible *bool `json:"forwardCompatible,omitempty"`
}
...
type ExampleDatetimeRfc2822 struct {
	Datetime time.Time `json:"datetime"`
	Raw      *string   `json:"raw,omitempty"`
}

func (e *ExampleDatetimeRfc2822) String() string {
	if value, err := core.StringifyJSON(e); err == nil {
		return value
	}
	return fmt.Sprintf("%#v", e)
...
func NewExamplePrimitiveFromDatetimeRfc2822(value *ExampleDatetimeRfc2822) *ExamplePrimitive {
	return &ExamplePrimitive{Type: "datetimeRfc2822", DatetimeRfc2822: value}
}
...
func (e *ExamplePrimitive) UnmarshalJSON(data []byte) error {
	...
	case "datetimeRfc2822":
		value := new(ExampleDatetimeRfc2822)
		if err := json.Unmarshal(data, &value); err != nil {
			return err
		}
		e.DatetimeRfc2822 = value
	case "uuid":
		var valueUnmarshaler struct {
...
func (e ExamplePrimitive) MarshalJSON() ([]byte, error) {
	...
	case "datetimeRfc2822":
		var marshaler = struct {
			Type string `json:"type"`
			*ExampleDatetimeRfc2822
		}{
			Type:                   e.Type,
			ExampleDatetimeRfc2822: e.DatetimeRfc2822,
		}
		return json.Marshal(marshaler)
	case "uuid":
		var marshaler = struct {
...
type ExamplePrimitiveVisitor interface {
	...
	VisitDatetimeRfc2822(*ExampleDatetimeRfc2822) error
...
func (e *ExamplePrimitive) Accept(visitor ExamplePrimitiveVisitor) error {
	...
	case "datetimeRfc2822":
		return visitor.VisitDatetimeRfc2822(e.DatetimeRfc2822)
	case "uuid":
...
const (
	...
	PrimitiveTypeV1DateTimeRfc2822 PrimitiveTypeV1 = "DATE_TIME_RFC_2822"
...
func NewPrimitiveTypeV1FromString(s string) (PrimitiveTypeV1, error) {
	...
	case "DATE_TIME_RFC_2822":
		return PrimitiveTypeV1DateTimeRfc2822, nil
	case "UUID":
...
func NewPrimitiveTypeV2FromDateTimeRfc2822(value *DateTimeRfc2822Type) *PrimitiveTypeV2 {
	return &PrimitiveTypeV2{Type: "dateTimeRfc2822", DateTimeRfc2822: value}
}
...
func (p *PrimitiveTypeV2) UnmarshalJSON(data []byte) error {
	...
	case "dateTime":
		...
		p.DateTime = value
	case "dateTimeRfc2822":
		value := new(DateTimeRfc2822Type)
		if err := json.Unmarshal(data, &value); err != nil {
			return err
		}
		p.DateTimeRfc2822 = value
	case "uuid":
		value := new(UuidType)
		if err := json.Unmarshal(data, &value); err != nil {
			return err
	...
	case "dateTimeRfc2822":
		var marshaler = struct {
			...
			*DateTimeRfc2822Type
			...
			Type:                p.Type,
			DateTimeRfc2822Type: p.DateTimeRfc2822,
		}
		return json.Marshal(marshaler)
	case "uuid":
		var marshaler = struct {
...
type PrimitiveTypeV2Visitor interface {
	...
	VisitDateTimeRfc2822(*DateTimeRfc2822Type) error
...
func (p *PrimitiveTypeV2) Accept(visitor PrimitiveTypeV2Visitor) error {
	...
	case "dateTimeRfc2822":
		return visitor.VisitDateTimeRfc2822(p.DateTimeRfc2822)
	case "uuid":
...
type WebhookPayloadBodySort string

const (
	WebhookPayloadBodySortAlphabetical WebhookPayloadBodySort = "ALPHABETICAL"
)

func NewWebhookPayloadBodySortFromString(s string) (WebhookPayloadBodySort, error) {
	switch s {
	case "ALPHABETICAL":
		return WebhookPayloadBodySortAlphabetical, nil
	}
	var t WebhookPayloadBodySort
	return "", fmt.Errorf("%s is not a valid %T", s, t)
}

func (w WebhookPayloadBodySort) Ptr() *WebhookPayloadBodySort {
	return &w
}
...
type WebhookPayloadFormat struct {
	...
	BodySort *WebhookPayloadBodySort `json:"bodySort,omitempty"`
}
...
type WebSocketChannel struct {
	...
	DisplayName       *string               `json:"displayName,omitempty"`
	ConnectMethodName *string               `json:"connectMethodName,omitempty"`
	BaseUrl           *EnvironmentBaseUrlId `json:"baseUrl,omitempty"`
	Path              *HttpPath             `json:"path,omitempty"`
	Auth              bool                  `json:"auth"`
	Headers           []*HttpHeader         `json:"headers,omitempty"`
