...
type OAuthRefreshEndpoint struct {
	...
	EndpointReference  EndpointId                   `json:"endpointReference"`
	RequestProperties  *OAuthRefreshTokenProperties `json:"requestProperties,omitempty"`
	ResponseProperties *OAuthAccessTokenProperties  `json:"responseProperties,omitempty"`
}
