...
import (
	json "encoding/json"
	fmt "fmt"
	core "github.com/fern-api/ir-go/core"
...
type CursorPagination struct {
	Page    *QueryParameter   `json:"page,omitempty"`
...
type HttpEndpoint struct {
	...
	Examples          []*HttpEndpointExample `json:"examples,omitempty"`
}
...
type RequestProperty struct {
	...
	// by the path.
	PropertyPath []*Name               `json:"propertyPath,omitempty"`
